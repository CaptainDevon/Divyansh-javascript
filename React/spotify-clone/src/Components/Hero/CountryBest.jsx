...
import { countries } from '../../Constants/Values';
  ...
  return (
    <section className="mt-5 mx-5">
        <div className="flex justify-between items-center mb-2">
          <a href="#" className="text-lg font-bold hover:underline decoration-1">India's best</a>
